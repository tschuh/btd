...
namespace eval ::optrace {
  variable script "/heplnw039/tschuh/vivadoProjects/binaryTree/binaryTree.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /heplnw039/tschuh/vivadoProjects/binaryTree/binaryTree.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc /heplnw039/tschuh/vivadoProjects/binaryTree/binaryTree.srcs/constrs_1/new/top.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top top -part xcvu9p-flga2104-2L-e
